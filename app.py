...
selected = option_menu("Main Menu", ["About Project", "Predictions"],
                           ...
                           styles={"nav-link": {"font": "sans serif", "font-size": "20px", "text-align": "centre"},
                                   "nav-link-selected": {"font": "sans serif", "background-color": "#eab676"},
                                   "icon": {"font-size": "20px"}
                                   }
                           )
...
if selected == "About Project":
    ...
    with col1:
        ...
        st.markdown("# :amber[Singapore Resale Flat Prices Prediction]")
        st.markdown('<div style="height: 50px;"></div>', unsafe_allow_html=True)
        st.markdown("### :amber[Technologies :] Python, Pandas, Numpy, Scikit-Learn, Streamlit, Python scripting, "
                "Machine Learning, Data Preprocessing, Visualization, EDA, Model Building, Data Wrangling, "
                "Model Deployment")
        st.markdown("### :amber[Overview :] This project aims to construct a machine learning model and implement "
        ...
        st.markdown("### :amber[Domain :] Real Estate")
        #with col2:
            
            #st.image('pic2.jpg')
            #st.image('pic3.jpeg')
if selected == "Predictions":
    st.markdown("# :amber[Predicting Results based on Trained Models]")
    st.markdown("### :amber[Predicting Resale Price (Regression Task) (Accuracy: 86%)]")
...
#python -m streamlit run flat_project2.py 
